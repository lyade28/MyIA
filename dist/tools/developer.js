...
function readActiveProject(workspace) {
...
function detectAngularProjects(workspace) {
    try {
...
function writeActiveProject(workspace, absoluteProjectPath) {
...
function resolveBaseDir(workspace, optionalCwd) {
    if (optionalCwd)
        return path.resolve(workspace, optionalCwd);
...
function extractCreatedProjectPath(command, execCwd) {
